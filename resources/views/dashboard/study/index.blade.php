    ...
    <section class="bg-white mt-20 shadow-md rounded-lg overflow-hidden">
        <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex-row items-center justify-between p-4 space-y-3 sm:flex sm:space-y-0 sm:space-x-4">
                <div>
                    <h5 class="mr-3 font-semibold">Program Studi</h5>
                ...
                <div class="flex gap-4">
                    ...
                    <a href="/dashboard/expert/study/create" type="button"
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody id="exist">
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-3">{{ $study->nama }}</td>
                            <td class="px-4 py-3">{{ $study->keterangan }}</td>
                            <td class="px-4 py-3">
                                <div class="flex justify-end gap-2">
                                    <a href="/dashboard/expert/study/{{ $study->id }}/edit" type="button" class="font-medium text-blue-600 hover:underline">Ubah</a>
                                    <form action="/dashboard/expert/study/{{ $study->id }}" method="POST">
                                        @method('delete')
                                        @csrf
