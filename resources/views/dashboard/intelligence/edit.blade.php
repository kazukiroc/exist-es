...
<div class="p-12 sm:ml-64">
    <section class="bg-white mt-20 shadow-md rounded-lg max-w-md">
        <form action="/dashboard/expert/intelligence/{{ $intelligences->id }}" method="POST" class="relative bg-white rounded-lg shadow">
            @method('put')
            @csrf
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="jenis" id="jenis" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2.5" required value="{{ old('jenis', $intelligences->jenis) }}">
                </div>
{{--                <div>--}}
