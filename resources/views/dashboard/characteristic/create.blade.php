...
<div class="p-12 sm:ml-64">
    <section class="bg-white mt-20 shadow-md rounded-lg max-w-md">
        <form action="/dashboard/expert/characteristic" method="POST" class="relative bg-white rounded-lg shadow">
            @csrf
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="kode" id="kode" value="{{ App\Models\Characteristic::generateKode() }}" class="bg-gray-100 border border-gray-300 text-gray-500 sm:text-sm rounded-lg focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2.5" readonly>
                    @error('kode')
